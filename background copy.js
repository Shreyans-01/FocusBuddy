...
var arroflinks=["https://www.youtube.com/watch?v=YBozZ7ydV3g",    
    ...
    var lengthoflinks=[25,52,34,26,32,61,71,70,
        52,46,6,37,122,79,12,7,
        36,62,113,50,9,42,64,25,
        79,80,15,36,68,57,33,19,
        91,18,60,32,118,20,60,75,
        65,16,40,63,5,17,12,13,
        15,42];
...
function ring()
{
    ...
    var loadinglag = 5;
    video_url=arroflinks[a];
    chrome.tabs.create({url:video_url});
    //start counting down from the lengthoflink[a]
    
    //run this after the video is done
    setTimeout (function () {
